...
const I18N = (function () {
  const DICT = {
    en: {
      ...
      // easter eggs
      'eggs.title': 'easter eggs',
      'eggs.hint': 'find them all for a surprise',
      'eggs.found': 'found',
      'eggs.all': 'all eggs found!',
      'eggs.reward': 'achievement unlocked: you read the whole desktop. thank you.',
      'egg.sudo.name': 'sudo',
      'egg.sudo.hint': "ask the terminal for powers you don't have",
      'egg.rmrf.name': 'rm -rf /',
      'egg.rmrf.hint': 'try to delete everything',
      'egg.vim.name': 'escaped vim',
      'egg.vim.hint': 'get stuck in vim, then get out',
      'egg.cow.name': 'cowsay',
      'egg.cow.hint': 'make a cow talk',
      'egg.matrix.name': 'matrix',
      'egg.matrix.hint': 'follow the white rabbit',
      'egg.sl.name': 'sl',
      'egg.sl.hint': 'misspell ls',
      'egg.konami.name': 'konami code',
      'egg.konami.hint': '↑ ↑ ↓ ↓ ← → ← → B A',
      'egg.clock.name': 'clock',
      'egg.clock.hint': 'time is a flat circle: click it three times',
      'egg.arch.name': 'the mountain',
      'egg.arch.hint': 'click the mountain in readme.txt',
    ...
    fr: {
      ...
      'eggs.title': 'easter eggs',
      'eggs.hint': 'trouvez-les tous pour une surprise',
      'eggs.found': 'trouvé',
      'eggs.all': 'tous les eggs trouvés !',
      'eggs.reward': 'succès débloqué : vous avez fait le tour du bureau. merci.',
      'egg.sudo.name': 'sudo',
      'egg.sudo.hint': "demandez au terminal des pouvoirs que vous n'avez pas",
      'egg.rmrf.name': 'rm -rf /',
      'egg.rmrf.hint': 'essayez de tout supprimer',
      'egg.vim.name': 'sorti de vim',
      'egg.vim.hint': 'restez coincé dans vim, puis sortez-en',
      'egg.cow.name': 'cowsay',
      'egg.cow.hint': 'faites parler une vache',
      'egg.matrix.name': 'matrix',
      'egg.matrix.hint': 'suivez le lapin blanc',
      'egg.sl.name': 'sl',
      'egg.sl.hint': 'faites une faute de frappe sur ls',
      'egg.konami.name': 'code konami',
      'egg.konami.hint': '↑ ↑ ↓ ↓ ← → ← → B A',
      'egg.clock.name': "l'horloge",
      'egg.clock.hint': "le temps est un cercle plat : cliquez l'horloge trois fois",
      'egg.arch.name': 'la montagne',
      'egg.arch.hint': 'cliquez la montagne dans readme.txt',
